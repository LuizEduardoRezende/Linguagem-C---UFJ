#include <stdio.h>
/*Para melhorar a ordenação da questão anterior eu utilizaria de algoritimos mais eficientes como por exemplo o
quicksort, que utiliza da estratégia de dividir e conquistar*/
